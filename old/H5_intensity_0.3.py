...
def peak_info(d):
        ...
        if peaks.size>0:
            ...
            #max_peak_positions.append(max_peak_position)
...
np.save(analysis_path+'/mapping_stuff/'+'max_value',np.array(d_list))
plot = well_plot(d_list,xpix,ypix) #plots well map of chosen parameters
#d_list.sort(reverse = True)
#print ("highest value is "+ str(d_list[0])+", second highest is "+str(d_list[1]))
