...
`       number of rows in input diffraction array
    ...
    writecorrfreq : int
        Frequency to write out the correlation function (default 1000000 patterns)
    """
    ...
    def __init__(self):
        ...
        self.add_parameter("writecorrfreq", 1000000, cmdline="--writecorrfreq",cmdline2="-wrc",
                 help="write out the correlation function at this frequency",
                 nargs=1,header=ch[0],pathflag=False)

        self.add_parameter("qbmin", -1, cmdline="--qbmin",cmdline2="-qbn", 
                 help="minimum q bin to correlate. Default = 0",
                 nargs=1,header=ch[0],pathflag=False)
        
        self.add_parameter("qbmax", -1, cmdline="--qbmax",cmdline2="-qbx",
                 help="maximum q bin to correlate. Default = nq",
                 nargs=1,header=ch[0],pathflag=False)
    ...
    def read_config_file(self):
        ...
        #print("debug paramsCORR dz", self.dz)
        self.qmax_calc()
